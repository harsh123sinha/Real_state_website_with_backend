...
<div class="logo">
	<a href="index.php">
		...
		<h2><b><a href="one.html"target="_blank">Harsh To-Let Services</a></b><br><h4><a href="one.html"target="_blank">"  click above to know more  "<h4></h2></a>
...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="Search your desired room here..." name="product" required="required" />
			...
			<div class="items-cart-inner">
				<div class="total-price-basket">
					...
					<span class="total-price">
						...
						<span class="value"><?php echo $_SESSION['']; ?></span>
					</span>
				</div>
				<div class="basket">
					<!-- <i class="glyphicon glyphicon-shopping-cart"></i> -->
				</div>
				<div class="basket-item-count"><span class="count"><?php echo $_SESSION[''];?></span></div>
